...
export default function About() {
  return (
    <p className="mb-4 text-gray-700 text-base leading-relaxed">
      ...
      you are browsing, studying, or multitasking, HearText provides clear,
      natural-sounding speech to help you effortlessly consume information.
      Experience seamless accessibility and convenience—because everyone
      deserves easy access to information.
    </p>
  );
}
